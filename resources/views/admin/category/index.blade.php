...
@section('content_header')
	<h1>Filcaspro<small> Category Adminitration</small></h1>
@endsection
		...
		<div class="box-body">
			<div class="row">
                ...
                @include('layouts/error_box')
                    ...
                    <a href="{{ route('category.create') }}" title="Add new Category" class="btn btn-primary btn-xs">
		...
		$(document).ready(function() {
				...
				columnDefs: [
					...
					},
                    {
						...
						'render': function (data, type, row) {
							return [
								'<a href="category/' + row['id'] + '/edit" title="Edit" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i> Edit</a>' + " " +
			...
			*/
			$(document).on("click", ".delete-btn", function () {
				...
				var url = '{{ route('category.destroy', ':id') }}'.replace(':id', id);
				console.log(url);
				console.log(id);
