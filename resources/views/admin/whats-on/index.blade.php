...
@section('content_header')
	<h1>Filcaspro<small> What's On Administration</small></h1>
@endsection
			...
			<div class="row">
				<div class="col-xs-12">
					@include('layouts/error_box')
						...
						<a href="{{ route('whats-on.create') }}" title="Add new Event" class="btn btn-primary btn-xs">
				...
				columnDefs: [
					...
					},
					{
						...
						'render': function (data, type, row) {
							return [
								'<a href="whats-on/' + row['id'] + '/edit" title="Edit" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i> Edit</a>' + " " +
