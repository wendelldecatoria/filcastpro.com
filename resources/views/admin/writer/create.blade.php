...
@section('content_header')
	<h1>Filcaspro<small> Create Writer</small></h1>
@endsection
		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">
                    ...
                    {{Form::open(array('route' => array('writer.store'), 'method' => 'POST', 'class' =>'form-horizontal', 'files' => true))}}
                    {{ csrf_field() }}
                    <table class="table table-striped table-bordered table-hover table-sm datatable mdl-data-table dataTable" role="grid" style="width: 80%;">
						<tbody>
                            <tr>
                                <td>Name:</td>
                                <td>{{Form::text('name', null , array('class' => 'form-control','placeholder' => 'Enter Writer Name')) }}</td>
                            </tr>
                            <tr>
                                <td>Title:</td>
                                <td>{{ Form::text('title', null , array('class' => 'form-control','placeholder' => 'Enter Writer Title')) }}</td>
                            </tr>
                            <tr>
                                <td>Image:</td>
